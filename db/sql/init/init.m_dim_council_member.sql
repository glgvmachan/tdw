...
SELECT *
  INTO #tmp_vw_data
  /* ---------
     IMPORTANT:  Varation of getting MONTHLY batches for initial load which is implemented in the view below
                 This script is called from a shell script that loops for as many months as needed 
     ---------- */
  FROM POC..vw_mthly_council_member_src 
go
...
SET @vMAXRANKNO = 
         ...
         SELECT VCMS.COUNCIL_MEMBER_ID
           ...
           -- FROM POC..vw_council_member_src VCMS
