...
CREATE OR ALTER VIEW vw_all_council_member_src
AS
...
(
    ...
    SELECT cmfh.COUNCIL_MEMBER_ID
     ...
     WHERE (
             ...
             OR cmfh.FLAG_RELATION_LAST_UPDATE_DATE >= (
                                     SELECT last_run_date
                                       FROM jobcontrol 
                                      WHERE name = 'DIM_COUNCIL_MEMBER'
                                        AND active_ind = 1
